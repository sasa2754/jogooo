...
int main() 
{
    ...
    FILE *ranking = fopen("ranking_agora_vai.txt", "a");
    FILE *history = fopen("history.txt", "a");

    if (history == NULL || ranking == NULL) {
    ...
    case 1:
        ...
        // Cria as duas threads e roda elas
    ...
    case 2:
        ...
        Queue queue1 = read_txt(history, str, 50);
        sort_ranking(&queue1, ranking);
        for (int i = 0; i < queue1.size; i++)
        {
            printf("\n%d", queue1.array[i].score);
            Sleep(500);
        }
        ...
        register_ranking(ranking, queue1);
        Sleep(10000);
        break;
